...
(
	 ...
	 O_DESCRIPCION  VARCHAR2(30) NOT NULL,	-- Descripcion de la  CATEGORIA (Nombre de la  CATEGORIA) definida por la convocatoria para el apoyo alimentario
...
(
	 ...
	 I_DOCUMENTO  BLOB NOT NULL,	-- Archivos de los documentos adjuntados al soporte de la  CATEGORIA definida para la convocatoria.
