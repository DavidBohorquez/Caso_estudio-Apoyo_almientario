...
(
	...
	"O_DESCRIPCION" VARCHAR2(30) NOT NULL,	-- Descripcion de la categoría (Nombre de la categoría) definida por la convocatoria para el apoyo alimentario
...
(
	"K_CONECUTIVO" NUMBER(2) NOT NULL,	-- Número consecutivo para una condición de la categoria.
	"K_ID_CATEGORIA" VARCHAR2(50) NOT NULL,	-- Id de la categoría como parte de la llave primaria.
	"O_DESCRIPCION" VARCHAR2(30) NOT NULL,	-- descripción de la condición actual
...
(
	...
	"O_OBSERVACION" VARCHAR2(20) NOT NULL,	-- Breve descripción del estado actual de la solicitud
...
(
	...
	"O_DESCRIPCION" VARCHAR2(50) NOT NULL,	-- Descripción del estado (razones) del soporte de la categoría definida para el apoyo alimentario.
	"I_TIPO" VARCHAR2(10) NOT NULL,	-- Tipo de la extensión del documento que se adjunta para la categoría del apoyo alimentario.
	...
	"I_DOCUMENTO" BLOB NOT NULL,	-- Archivos de los documentos adjuntados al soporte de la categoría definida para la convocatoria.
	"Q_PUNTAJE" NUMBER(3) NOT NULL,	-- Sumatoria de los puntajes de la categoría del apoyo alimentario.
	"ID_CATEGORIA" VARCHAR2(10) NOT NULL	-- Foreing key a la categoría del apoyo alimentario.
)
;
...
COMMENT ON TABLE  "Categoria" IS 'Tabla para las categorías definidas por la convocatoria del apoyo alimentario.';

COMMENT ON COLUMN  "Categoria"."O_DESCRIPCION" IS 'Descripcion de la categoría (Nombre de la categoría) definida por la convocatoria para el apoyo alimentario';

COMMENT ON COLUMN  "Categoria"."ID_CONVOCATORIA" IS 'Foreing key de la convocatoria';

COMMENT ON TABLE  "Condicion" IS 'Tabla para las condiciones (entidad débil) que hacen parte de una categoría en particular.';

COMMENT ON COLUMN  "Condicion"."K_CONECUTIVO" IS 'Número consecutivo para una condición de la categoria.';

COMMENT ON COLUMN  "Condicion"."K_ID_CATEGORIA" IS 'Id de la categoría como parte de la llave primaria.';
...
COMMENT ON TABLE  "Soporte" IS 'Tabla para los soporte de las categorías definidas para el apoyo alimentario.';

COMMENT ON COLUMN  "Soporte"."K_ID" IS 'código de identificación del soporte';

COMMENT ON COLUMN  "Soporte"."O_DESCRIPCION" IS 'Descripción del estado (razones) del soporte de la categoría definida para el apoyo alimentario.';

COMMENT ON COLUMN  "Soporte"."I_TIPO" IS 'Tipo de la extensión del documento que se adjunta para la categoría del apoyo alimentario.';
...
COMMENT ON COLUMN  "Soporte"."I_DOCUMENTO" IS 'Archivos de los documentos adjuntados al soporte de la categoría definida para la convocatoria.';

COMMENT ON COLUMN  "Soporte"."Q_PUNTAJE" IS 'Sumatoria de los puntajes de la categoría del apoyo alimentario.';

COMMENT ON COLUMN  "Soporte"."ID_CATEGORIA" IS 'Foreing key a la categoría del apoyo alimentario.';
...
ALTER TABLE  "Condicion"
 ADD CONSTRAINT "PK_CONDICION"
	PRIMARY KEY ("K_CONECUTIVO","K_ID_CATEGORIA")
 USING INDEX
;
...
ALTER TABLE  "Convocatoria"
 ADD CONSTRAINT "chk_periodo" CHECK (q_periodo in (1,3))
;
...
ALTER TABLE  "Estudiante"
 ADD CONSTRAINT "CHK_PERIODO" CHECK (I_PERIODO_ACT in (1,3))
;
